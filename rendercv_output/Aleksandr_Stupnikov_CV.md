# Aleksandr Stupnikov's CV

- Email: [a.stupnikov05@gmail.com](mailto:a.stupnikov05@gmail.com)
- Location: Bremen, Germany
- LinkedIn: [a-stupnikov](https://linkedin.com/in/a-stupnikov)
- GitHub: [enotvtapke](https://github.com/enotvtapke)
...
- GPA 2.07 #link("https://github.com/enotvtapke/cv/blob/master/constructor_transcript.pdf")[Transcipt]
...
- GPA: 4.4\/5.0 #link("https://github.com/enotvtapke/cv/blob/master/itmo_transcript.pdf")[Transcipt]
...
- Languages: Kotlin, Java, Haskell, SQL, C

- Technologies: JUnit, Ktor, ANTLR, PostreSQL, Git, Docker, Gradle, Bash, IntelliJ IDEA, VSCode

# Experience

## **Intern**, #link("https://www.jetbrains.com")[JetBrains] -- Remote, Germany
...
## **Software Engineer**, #link("https://www.lipt-soft.ru")[Liptsoft] -- Saint Petersburg, Russia
